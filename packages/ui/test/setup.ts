...
// happy-dom has no rAF-driven layout, and several components use rAF to let a mounted
// node settle before its enter transition. Run it on the next macrotask instead.
