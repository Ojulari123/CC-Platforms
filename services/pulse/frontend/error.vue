...
/* Where an unknown address lands. Nuxt's stock page has one button and no idea whether
   there is a session, so a wrong URL inside Pulse read as a dead end. The screen itself is
...
useHead({ title: () => (status.value === 404 ? "Not found · Pulse" : "Something went wrong · Pulse") });
</script>
